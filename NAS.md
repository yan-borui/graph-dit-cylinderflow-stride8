...
export AUTOENCODER=/path/to/airfoil/vgae/dit_autoencoder.pt
...
Airfoil 注意力消融使用同一包装入口：

```bash
export COHORT="$NAS_ROOT/runs/airfoil_attention"
bash scripts/nas.sh bash scripts/airfoil_ablation_4gpu.sh train h1
```
