...
其他方法及补充实验见[全部 NAS 入口](NAS_INDEX.md)。
...
本分支任务说明：[FOUR_GPU.md](FOUR_GPU.md)、[PARETO.md](PARETO.md)、[TRAINING_CURVE.md](TRAINING_CURVE.md)、[README.md](README.md)。

基于已有冻结源码的新训练种子使用 [种子补充入口](campaigns/training_seed/README.md)，先在独立源码副本应用锁适配，再启动新任务。
